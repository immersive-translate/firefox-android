...
class EmailLoginFragmentDialog : BottomSheetDialogFragment() {
    private lateinit var binding: DialogLoginFragmentLayoutBinding
    private lateinit var loginFragment: EmailLoginFragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        loginFragment = EmailLoginFragment.newInstance(
            isDialog = true,
            onResetPwd = {
                ResetPasswordFragmentDialog().show(
                    parentFragmentManager,
                    "DialogResetPasswordFragment",
                )
                dismiss()
            },
        )
