...
//	public final static String JAVASCRIPT_STR = "javascript:";
    ...
    public static final String JAVA_SCRIPT = "jsbridge/WebViewJavascriptBridge.js";
    ...
    public static JsonArray getDataFromReturnUrl(String url) {
        if (!TextUtils.isEmpty(url)) {
            try {
                String data = url.replace(YY_FETCH_QUEUE, "");
                return gson.fromJson(data, new TypeToken<JsonArray>() {
                }.getType());
